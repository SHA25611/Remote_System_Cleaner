...
echo " "
export DISPLAY=$(cat ./disp_env/display_var)
echo "Display has been integrated to $DISPLAY, please do not close" 
echo "this SGD session while using the script.                    "
#rm -rf disp_env
...
echo " "
   ...
   echo "|       then keep the session on standby and just connect to the    |"
   echo "|       soltau2 using puTTy application and after that run your copy|"
   echo "|      of RSC puTTY version on the puTTy application itself.        |"
...
while :
 do
  ...
  then
   ...
   echo " "
   echo "-----------------------------------------------------------------------------------------------------"
   echo "|Display has been removed, please make sure to integrate the display again before using this script |"
   echo "-----------------------------------------------------------------------------------------------------"
   echo " "
   break
  fi  
